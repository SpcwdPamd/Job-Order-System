...
// Build a human-readable snapshot from the personnel list
...
// Write the first monthly log entry
...
// Write/update monthly log for this month
await _MonthlyLogHelper.upsertLog(
...
// Resolve names from snapshot (preferred) or from personnel list
...
// ─────────────────────────────────────────────────────────────────────────────
//  EDIT PERSONNEL TAB  (unchanged from original)
// ─────────────────────────────────────────────────────────────────────────────
...
style: TextStyle(color: _tk.txtHead, fontSize: 14),
decoration: _inputDeco('Contact Number', icon: Icons.phone_outlined)),
const SizedBox(height: 14),
TextField(
controller: _addressCtrl,
style: TextStyle(color: _tk.txtHead, fontSize: 14),
decoration: _inputDeco('Address', icon: Icons.home_outlined)),
const SizedBox(height: 14),
DropdownButtonFormField<String>(
...
_contactCtrl.text = p['contact_number'] ?? '';
