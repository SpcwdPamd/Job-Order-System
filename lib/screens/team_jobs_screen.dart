// team_jobs_screen.dart  (UPDATED)
//
// Changes vs original:
//  • Import notification_helper.dart
//  • In _markAsAccomplished: after the Supabase update succeeds, look up the
//    job's team_id and call NotificationHelper.notifyJobAccomplished(...)
//
// Every other line is identical to your original.
...
import 'package:job_order/core/utils/notification_helper.dart'; // ← NEW
...
class _TeamJobsScreenState extends State<TeamJobsScreen> {
  ...
  // ── UPDATED: write notification after marking accomplished ────────────────
  Future<void> _markAsAccomplished(
      String jobId, {
        int? zone,
        // pass the full job map so we can grab team_id, jo_number etc.
    ...
    try {
      ...
      // ── NEW: fire accomplished notification ──────────────────────────────
  ...
  void _showEditJobOrderDialog(Map<String, dynamic> job) {
    ...
    String? selectedAddress = (savedAddr != null && addresses.contains(savedAddr)) ? savedAddr : null;
    bool showCustomAddress = savedAddr != null && savedAddr.isNotEmpty && !addresses.contains(savedAddr);
                    ...
                    Expanded(child: SingleChildScrollView(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        TextField(
                          ...
                          decoration: dsInputOf(context, '', hint: 'e.g. JO-2025-001',
                            ...
                            child: AnimatedContainer(
                              ...
                              child: Row(children: [
                                ...
                                if (isSel)
                                  Container(
                                    width: 18, height: 18,
                                    decoration: BoxDecoration(shape: BoxShape.circle, color: tk.blue),
                        ...
                        _dropdownTile(
                          ...
                          label: workTypeCode == null ? 'Select type of work…' : _workTypeName(workTypeCode),
                        ...
                        Wrap(spacing: 10, runSpacing: 10, children: [
                          for (final entry in [
                            ...
                            Builder(builder: (_) {
                              ...
                              return GestureDetector(
                                onTap: () => setS(() => difficultyLevel = isSel ? null : level),
                                child: AnimatedContainer(
                                  duration: const Duration(milliseconds: 150),
                                  padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 10),
                                  decoration: BoxDecoration(
                                    color: isSel ? chipColor.withOpacity(0.10) : tk.surf2,
                                    borderRadius: BorderRadius.circular(10),
                                    border: Border.all(
                                        color: isSel ? chipColor.withOpacity(0.50) : tk.bd,
                                        width: isSel ? 1.5 : 1),
                                    boxShadow: isSel
                                        ? [BoxShadow(color: chipColor.withOpacity(0.15), blurRadius: 8)]
                                        : null,
                                  ),
                                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                                    if (isSel) ...[
                                      Icon(Icons.check_rounded, color: chipColor, size: 13),
                                      const SizedBox(width: 5),
                                    ],
                        ...
                        _dropdownTile(
                          ...
                          label: damagedCode == null ? 'Select damaged space…' : _damagedName(damagedCode),
                        ...
                        if (selectedAddress != null)
                          Container(
                            ...
                            child: Row(children: [
                              Icon(Icons.location_on_rounded, color: tk.blue, size: 15),
                              const SizedBox(width: 8),
                              Expanded(child: Text(selectedAddress!,
                                  style: TextStyle(color: tk.txtHead, fontSize: 13,
                                      fontWeight: FontWeight.w600))),
                              GestureDetector(
                                onTap: () => setS(() => selectedAddress = null),
                                child: Icon(Icons.close_rounded, color: tk.txtMuted, size: 15),
                              ),
                            ]),
                          ),
                        Container(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return GestureDetector(
                                onTap: () => setS(() {
                                  ...
                                  showCustomAddress = addr == 'Others / No Address Listed';
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: isSel ? tk.blueBd : Colors.transparent),
                                  ),
                                  child: Row(children: [
                                    Icon(isSel ? Icons.check_circle_rounded : Icons.location_on_outlined,
                                        color: isSel ? tk.blue : tk.txtMuted, size: 14),
                                    const SizedBox(width: 8),
                        ...
                        if (showCustomAddress) ...[
                          ...
                          TextField(
                            ...
                            decoration: dsInputOf(context, '', hint: 'Enter custom address…',
                        ...
                        TextField(
                          ...
                          maxLines: 3,
                          style: TextStyle(color: tk.txtHead, fontSize: 13.5),
                          decoration: dsInputOf(context, '', hint: 'e.g. near the old market',
                        ...
                        TextField(
                          ...
                          style: TextStyle(color: tk.txtHead, fontSize: 13.5),
                          decoration: dsInputOf(context, '', hint: 'Enter zone number',
                        ...
                        GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                                    ...
                                    Text('Mark as Accomplished?',
                                        style: TextStyle(color: tk.txtHead, fontSize: 16,
                                            fontWeight: FontWeight.w800)),
                                    const SizedBox(height: 8),
                                    Text(zoneNum != null ? 'Zone: $zoneNum' : 'No zone specified',
                          ...
                          child: Container(
                            ...
                            child: Center(child: Row(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Text('Mark as Accomplished',
                                  style: TextStyle(color: tk.green, fontSize: 14,
                                      fontWeight: FontWeight.w700)),
                            ])),
                          ),
                        ),
                        ...
                        Row(children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Center(child: Text('Cancel',
                                  style: TextStyle(color: tk.txt, fontSize: 13.5,
                                      fontWeight: FontWeight.w600))),
                            ),
                          ),
                          const SizedBox(width: 10),
                          Expanded(child: GestureDetector(
                            onTap: () async {
                              ...
                              final finalAddr = showCustomAddress
                                  ...
                                  ? customAddrCtrl.text.trim() : 'No address')
                                  : (selectedAddress ?? 'No address selected');

                              final updates = {
                                'jo_number':          joNum,
                                if (selectedTeamId != null) 'team_id': selectedTeamId,
                                ...
                                'remarks':            remarksCtrl.text.trim().isNotEmpty
                                    ? remarksCtrl.text.trim() : null,
                                'zone':               zoneCtrl.text.trim().isNotEmpty
                                    ? int.tryParse(zoneCtrl.text.trim()) : null,
  ...
  Widget _sectionLabel(String text) => Padding(
    ...
    child: Text(text,
        style: TextStyle(color: _tk.txtHead, fontSize: 13, fontWeight: FontWeight.w600)),
  );

  Widget _dropdownTile({required IconData icon, required String label,
    required bool isSelected, required Color accent, required VoidCallback onTap}) {
    final tk = _tk;
    return GestureDetector(
      onTap: onTap,
      child: AnimatedContainer(
  ...
  void _showWorkTypeSheet(BuildContext ctx, String? current, Function(String) onSelect) {
    final tk = _tk;
    showModalBottomSheet(
      context: ctx, isScrollControlled: true, backgroundColor: Colors.transparent,
      builder: (_) => DraggableScrollableSheet(
        initialChildSize: 0.65, minChildSize: 0.5, maxChildSize: 0.92, expand: false,
        builder: (_, sc) => Container(
          decoration: BoxDecoration(color: tk.surf,
              borderRadius: const BorderRadius.vertical(top: Radius.circular(24)),
              border: Border(top: BorderSide(color: tk.bd))),
          child: Column(children: [
            Padding(padding: const EdgeInsets.symmetric(vertical: 12),
                child: Container(width: 42, height: 5,
                    decoration: BoxDecoration(color: tk.bd2, borderRadius: BorderRadius.circular(10)))),
            Padding(padding: const EdgeInsets.fromLTRB(20, 0, 20, 14),
                child: Row(children: [
                  Container(width: 36, height: 36,
                      decoration: BoxDecoration(color: tk.blueBg,
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(color: tk.blueBd)),
                      child: Icon(Icons.build_rounded, color: tk.blue, size: 17)),
                  const SizedBox(width: 12),
                  Text('Type of Work', style: TextStyle(
                      color: tk.txtHead, fontSize: 16, fontWeight: FontWeight.w800)),
                ])),
            ...
            Expanded(child: workTypes.isEmpty
                ...
                : ListView.builder(
              controller: sc, itemCount: workTypes.length,
              ...
              itemBuilder: (_, i) {
                ...
                return GestureDetector(
                  onTap: () { onSelect(wt['code']!); Navigator.pop(ctx); },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(color: isSel ? accent.withOpacity(0.30) : Colors.transparent),
                    ),
                    child: Row(children: [
                      Container(width: 36, height: 36,
                          decoration: BoxDecoration(
                              color: isSel ? accent.withOpacity(0.14) : tk.surf2,
                              borderRadius: BorderRadius.circular(9),
                              border: Border.all(color: isSel ? accent.withOpacity(0.28) : tk.bd)),
                          child: Center(child: Text(wt['code']!,
                              style: TextStyle(color: isSel ? accent : tk.txtMuted,
                                  fontSize: 10, fontWeight: FontWeight.w800)))),
                      const SizedBox(width: 12),
                      Expanded(child: Text(wt['name']!,
                          style: TextStyle(color: isSel ? tk.txtHead : tk.txt, fontSize: 14,
                              fontWeight: isSel ? FontWeight.w700 : FontWeight.w400))),
                      if (isSel) Icon(Icons.check_circle_rounded, color: accent, size: 20),
                    ]),
                  ),
                );
              },
  ...
  void _showDamagedSpaceSheet(BuildContext ctx, String? current, Function(String) onSelect) {
    final tk = _tk;
    showModalBottomSheet(
      context: ctx, isScrollControlled: true, backgroundColor: Colors.transparent,
      builder: (_) => DraggableScrollableSheet(
        initialChildSize: 0.45, minChildSize: 0.35, maxChildSize: 0.70, expand: false,
        builder: (_, sc) => Container(
          decoration: BoxDecoration(color: tk.surf,
              borderRadius: const BorderRadius.vertical(top: Radius.circular(24)),
              border: Border(top: BorderSide(color: tk.bd))),
          child: Column(children: [
            ...
            Padding(padding: const EdgeInsets.fromLTRB(20, 0, 20, 14),
                child: Row(children: [
                  Container(width: 36, height: 36,
                      decoration: BoxDecoration(color: tk.amberBg,
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(color: tk.amberBd)),
                      child: Icon(Icons.foundation_rounded, color: tk.amber, size: 17)),
                  const SizedBox(width: 12),
            ...
            Expanded(child: damagedOptions.isEmpty
                ...
                style: TextStyle(color: tk.txtMuted)))
                : ListView.builder(
              controller: sc, itemCount: damagedOptions.length,
              padding: const EdgeInsets.symmetric(vertical: 8),
              itemBuilder: (_, i) {
                final opt   = damagedOptions[i];
                final isSel = current == opt['code'];
                return GestureDetector(
                  onTap: () { onSelect(opt['code']!); Navigator.pop(ctx); },
                  child: Container(
                    margin: const EdgeInsets.symmetric(horizontal: 14, vertical: 3),
                    padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(color: isSel ? tk.amberBd : Colors.transparent),
                    ),
                    child: Row(children: [
                      Container(width: 36, height: 36,
                          decoration: BoxDecoration(
                              color: isSel ? tk.amber.withOpacity(0.14) : tk.surf2,
                              borderRadius: BorderRadius.circular(9),
                              border: Border.all(
                                  color: isSel ? tk.amber.withOpacity(0.28) : tk.bd)),
                          child: Center(child: Text(opt['code']!,
                              style: TextStyle(color: isSel ? tk.amber : tk.txtMuted,
                                  fontSize: 13, fontWeight: FontWeight.w800)))),
                      const SizedBox(width: 12),
                      Expanded(child: Text(opt['name']!,
                          style: TextStyle(color: isSel ? tk.txtHead : tk.txt, fontSize: 14,
                              fontWeight: isSel ? FontWeight.w700 : FontWeight.w400))),
                      if (isSel) Icon(Icons.check_circle_rounded, color: tk.amber, size: 20),
                    ]),
                  ),
                );
              },
  ...
  Widget _buildCreatedByChip(dynamic userId) {
    ...
    final display = user['full_name']!.isNotEmpty ? user['full_name']! : '@${user['username']}';
  ...
  Widget _buildJobOrderCard(Map<String, dynamic> job) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: tk.surf, borderRadius: BorderRadius.circular(14),
              ...
              child: Row(children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [accent, accent.withOpacity(0.82)],
                        begin: Alignment.topLeft, end: Alignment.bottomRight),
                    borderRadius: BorderRadius.circular(9),
                    boxShadow: [BoxShadow(color: accent.withOpacity(0.22),
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('${job['shift_time'] ?? '—'} • $displayTeam',
                      ...
                      style: TextStyle(color: tk.txtHead, fontSize: 14, fontWeight: FontWeight.w700)),
                  ...
                  if ((job['address'] ?? '').toString().isNotEmpty)
                    Row(children: [
                      Icon(Icons.location_on_rounded, size: 11, color: tk.txtMuted),
                      const SizedBox(width: 3),
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  Container(
                    ...
                    child: Text(diffLabel,
                        style: TextStyle(color: diffColor, fontSize: 10.5, fontWeight: FontWeight.w700)),
                  ),
                  ...
                  Container(
                    ...
                    child: Text(job['damaged_space_code'] ?? '—',
                        style: TextStyle(color: tk.amber, fontSize: 10.5, fontWeight: FontWeight.w700)),
                  ),
                  const SizedBox(height: 8),
                  Container(
                    width: 30, height: 30,
                    decoration: BoxDecoration(
                        color: tk.blueBg, borderRadius: BorderRadius.circular(8),
                        border: Border.all(color: tk.blueBd)),
      ...
      body: Column(children: [
          ...
          actions: [
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: tk.surf2, borderRadius: BorderRadius.circular(10),
                    border: Border.all(color: tk.bd)),
        ...
        Padding(
          ...
          child: DsSearchBar(
              ...
              onClear: () => setState(() => _filteredJobOrders = _jobOrders)),
        ),
        ...
        Expanded(
          child: _isLoading
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: tk.blue.withOpacity(0.30),
            ...
            child: ListView.builder(
              ...
              itemCount: _filteredJobOrders.length,
              itemBuilder: (context, index) =>
                  _buildJobOrderCard(_filteredJobOrders[index]),
            ),
          ),
        ),
      ]),
